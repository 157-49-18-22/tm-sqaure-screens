...
function Step2({ formData, onSubmit, onBack }) {
  ...
  const handleNext = async () => {
    ...
    try {
      const combinedData = { ...formData, ...form };
      const dbData = new FormData();
      Object.keys(combinedData).forEach(key => {
        if (combinedData[key] !== undefined && combinedData[key] !== null) {
          dbData.append(key, combinedData[key]);
        }
      });
    ...
    return (
      <div className="form-page">
        <div className="success-screen">
          ...
          <p className="success-sub">Your SBI FASTag registration has been submitted successfully.</p>
          <div className="success-details">
            <span>Vehicle: <strong>{form?.vehicleNumber || formData?.vehicleNumber}</strong></span>
            <span>Owner: <strong>{form?.ownerName || formData?.panName}</strong></span>
          </div>
  ...
  return (
    <div className="form-page">
      <div className="form-page-header">
        ...
        <h1 className="form-page-title">SBI FASTag Registration Step 2</h1>
